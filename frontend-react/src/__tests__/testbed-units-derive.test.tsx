...
const mount = async () => {
  ...
  act(() => { root.render(<QueryClientProvider client={new QueryClient({ defaultOptions: { queries: { retry: false } } })}><ShellProvider services={services}><TestBedHost bed={BED as never} /></ShellProvider></QueryClientProvider>) })
  await settle()
  return calls
}
