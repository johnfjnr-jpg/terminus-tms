...
const SHAPES: { name: string, ui: UiState, values: Values }[] = [
  { name: 'twoPhase / annual / client own',
    ui: { installResp: 'Client Own Installation Team', structure: 'twoPhase', invoicing: 'annual', grossUp: false, factoringEnabled: false, factoringMethod: 'straight', hostingPriceMode: 'margin', paymentMode: 'capex' },
  ...
  { name: 'single / monthly / factoring / per unit',
    ui: { installResp: 'Terminus Contractor - Per Unit', structure: 'single', invoicing: 'monthly', grossUp: true, factoringEnabled: true, factoringMethod: 'straight', hostingPriceMode: 'margin', paymentMode: 'capex' },
  ...
  { name: 'hybrid / declining / lump sum',
    ui: { installResp: 'Terminus Contractor - Lump Sum', structure: 'hybrid', invoicing: 'annual', grossUp: false, factoringEnabled: true, factoringMethod: 'declining', hostingPriceMode: 'margin', paymentMode: 'capex' },
