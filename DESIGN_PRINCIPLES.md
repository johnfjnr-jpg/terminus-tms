...
- **Notes-per-field-edit batching**: Contact detail's Save writes one Notes History entry per changed field, so saving several fields in one session produces several notes at once rather than one combined entry. Confirmed minor, not building now.
