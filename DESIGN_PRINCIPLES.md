...
8. Subsequent modules (Risk Register, Pilot, Deployment, then Asset Management and component tracking, then the rest of the build-not-buy list) plug into the existing engine rather than rebuilding it.
