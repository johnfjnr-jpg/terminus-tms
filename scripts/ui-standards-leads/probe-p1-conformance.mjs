...
// Passed as a FUNCTION, not as a string to be eval'd. The string form
// reported a plainly-visible 1920x1200 backdrop as invisible - measured
// display flex, opacity 1 - so a working refusal read as a regression.
// A function argument cannot be broken by quoting.
...
try {
  ...
  const visible = (sel) => page.evaluate(VISIBLE_FN, sel)
