...
const VIEW = {
  ...
  renderTestBedDetail: 'GAP: the view render - header, stat strip, banner, landing',
  loadTestBedDetail: 'GAP: the view load',
  renderTestBedDocuments: 'GAP: the documents panel CONTENT',
  confirmStageDocument: 'GAP: confirming a stage document',
  saveStageDocumentUrl: 'GAP: a stage document URL',
  tbDocKey: 'GAP: the document row key',
  renderTbStageApprovals: 'GAP: the approvals panel CONTENT',
  applyConfirmedApproval: 'GAP: an approval decision',
  renderTbClosedPanel: 'GAP: the terminal tab CONTENT',
  wireTbNextStageButton: 'GAP: the Next Stage ACTION',
  tbNextStageState: 'GAP: what Next Stage acts on',
  tbLandOnStageAfterLoad: 'GAP: the landing input StageTabs takes as a prop',
  tbArrivingFresh: 'GAP: the fresh-arrival input',
  tbFreshNavigation: 'GAP: the fresh-arrival input',
  refreshTbStagePanels: 'GAP: re-loading the open stage after a write',
  currentTestBed: 'GAP: the view record',
  tbDetailStages: 'GAP: the stage list the terminal check reads',
  convertTestBed: 'GAP: convert to Opportunity',
  wireTestBedConvertOnce: 'GAP: convert wiring',
  resetTestBedConvertForm: 'GAP: convert form reset',
}
