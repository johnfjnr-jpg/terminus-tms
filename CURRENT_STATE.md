...
- Generated at: `2026-09-25T07:06:12.049Z`
- Git commit: `6511d0530d7a0b37d71feca1982702cc7908d86a`
...
- Committed bundle: `frontend-react/dist/terminus-react.js`, 505,469 bytes
- sha256: `365a0975fea8ccb7da089e71288ced189bb871972b306758f1eb7885eed186c4`
- React suite: 1369/1369 pass, 0 fail

## Tags

| tag | published commit | date | commits from `HEAD` | local agrees |
|---|---|---|---|---|
| `controls-complete` | `56b516e` | 2026-08-29 | 906 | yes |
| `reshape-complete` | `3499884` | 2026-08-29 | 877 | yes |
...
| opportunity | 8 | assessCommRegulatoryDriver | Regulatory or external driver | Is something outside the buyer requiring this, rather than the buyer choosing it | (null) |
...
187 rows. Wording is not printed: it is provisional and
...
| assessCommRegulatoryDriver | 1 | 1, 2, 3, 4, 5 |
...
| opportunity | (null) | Evaluation | 40 |
...
132 live, 103322 soft deleted, 103454 rows in total.

| record_type | status | live | soft deleted |
|---|---|---|---|
| account | Active | 0 | 6 |
| account | active | 7 | 1603 |
| contact | Active | 0 | 2970 |
| contact | Nurture | 0 | 17 |
| contact | Qualified | 12 | 10204 |
| contact | Unqualified | 5 | 763 |
| document | approved | 65 | 5122 |
| document | draft | 0 | 5 |
| document | received | 1 | 78 |
| opportunity | Closed Lost | 0 | 20 |
| opportunity | Closed Won | 2 | 7 |
| opportunity | Evaluation | 0 | 258 |
| opportunity | Negotiating | 1 | 16 |
| opportunity | Proposal | 3 | 1585 |
| opportunity | Qualification | 5 | 8869 |
| opportunity | Solution Alignment | 7 | 1239 |
| test_bed | Closed | 5 | 9 |
| test_bed | Installation and Commissioning | 1 | 35 |
| test_bed | Monitoring and Analysis | 0 | 2 |
| test_bed | Pre-Site Assessment | 0 | 8 |
| test_bed | Qualification | 3 | 1423 |
| test_bed | Review and Completion | 1 | 0 |
| test_bed | Site Assessment | 1 | 17 |
| unit | Active | 0 | 1 |
| unit | Installed | 4 | 19 |
| unit | Planned | 9 | 19669 |
| unit | Removed | 0 | 1 |
...
4428 rows, of which 3 carry a null `stage`.

| decision | track | rows | null stage |
|---|---|---|---|
| approved | Commercial | 2176 | 0 |
| approved | Legal | 1232 | 1 |
| approved | Senior | 3 | 2 |
| approved | Technical | 1011 | 0 |
...
| GET | `/api/base-costs` | authenticated | `src/routes/base-costs.js` |
...
| POST | `/api/contacts/:id/qualify` | authenticated | `src/routes/contacts.js` |
...
| GET | `/api/opportunities/:id/approval-page` | authenticated | `src/routes/deal-sheet-versions.js` |
...
| GET | `/api/opportunities/:id/deal-sheet-versions` | authenticated | `src/routes/deal-sheet-versions.js` |
| POST | `/api/opportunities/:id/deal-sheet-versions` | authenticated | `src/routes/deal-sheet-versions.js` |
...
| GET | `/api/records/:id/pulse` | authenticated | `src/routes/records.js` |
...
84. `20260827000005_base_cost_batches.sql`
85. `20260827000006_deal_sheet_versions.sql`
86. `20260827000007_immutability_triggers.sql`
87. `20260827000008_version_author_email.sql`
88. `20260827000009_guard_author_on_relabel.sql`
89. `20260828000001_conditional_record_revision.sql`
90. `20260828000002_drop_stale_revision_overload.sql`
91. `20260828000003_stale_write_status_code.sql`
92. `20260829000001_version_carries_its_revision.sql`
...
105. `20260831000006_regulatory_or_external_driver.sql`
106. `20260831000007_currency_initial_values.sql`
107. `20260831000008_derive_required_tracks.sql`
108. `20260831000009_approval_inert_reason.sql`
109. `20260901000001_proposal_issued_criterion.sql`
110. `20260902000001_record_freshness.sql`
111. `20260902000002_record_freshness_off_the_record.sql`
112. `20260902000003_version_gate_from_proposal.sql`
113. `20260902000004_version_approvals_are_not_collected.sql`
114. `20260902000005_a_review_collects_the_version_tracks.sql`
