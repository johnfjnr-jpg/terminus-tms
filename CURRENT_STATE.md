...
- Generated at: `2026-09-19T05:23:59.475Z`
- Git commit: `89f3e5b1a915d5b0848b8a9d727ef6bb74288a71`
...
- Committed bundle: `frontend-react/dist/terminus-react.js`, 473,631 bytes
- sha256: `9036159ad4e8b14ca832cdd7dcc3f3ea2ccfe18aa6ea1df512d614233d7a8f5f`
- React suite: 1242/1242 pass, 0 fail

## Tags

| tag | published commit | date | commits from `HEAD` | local agrees |
|---|---|---|---|---|
| `controls-complete` | `56b516e` | 2026-08-29 | 760 | yes |
| `reshape-complete` | `3499884` | 2026-08-29 | 731 | yes |
...
132 live, 88459 soft deleted, 88591 rows in total.

| record_type | status | live | soft deleted |
|---|---|---|---|
| account | Active | 0 | 6 |
| account | active | 7 | 1451 |
| contact | Active | 0 | 2532 |
| contact | Nurture | 0 | 17 |
| contact | Qualified | 12 | 7895 |
| contact | Unqualified | 5 | 712 |
| document | approved | 65 | 4538 |
| document | draft | 0 | 5 |
| document | received | 1 | 78 |
| opportunity | Closed Lost | 0 | 20 |
| opportunity | Closed Won | 2 | 7 |
| opportunity | Evaluation | 0 | 208 |
| opportunity | Negotiating | 1 | 16 |
| opportunity | Proposal | 3 | 1276 |
| opportunity | Qualification | 5 | 6819 |
| opportunity | Solution Alignment | 7 | 1039 |
| test_bed | Closed | 5 | 9 |
| test_bed | Installation and Commissioning | 1 | 35 |
| test_bed | Monitoring and Analysis | 0 | 2 |
| test_bed | Pre-Site Assessment | 0 | 8 |
| test_bed | Qualification | 3 | 1271 |
| test_bed | Review and Completion | 1 | 0 |
| test_bed | Site Assessment | 1 | 17 |
| unit | Active | 0 | 1 |
| unit | Installed | 4 | 19 |
| unit | Planned | 9 | 17087 |
| unit | Removed | 0 | 1 |
...
3776 rows, of which 3 carry a null `stage`.

| decision | track | rows | null stage |
|---|---|---|---|
| approved | Commercial | 1875 | 0 |
| approved | Legal | 1031 | 1 |
| approved | Senior | 3 | 2 |
| approved | Technical | 861 | 0 |
